...
{
    static var instanceStr:String = '##LUA_STRING_TO_OBJ##';
	...
	public static public static function getPropertyLoop(lua:LuaScript, split:Array<String>, ?getProperty:Bool=true, ?allowMaps:Bool = false):Dynamic
	{
